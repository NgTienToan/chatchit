        ...
        <ClickAwayListener onClickAway={() => setIsDropdownOpened(false)}>
          {(ref) => (
            <div ref={ref} className="relative">
              ...
              <div
                className={`absolute top-full right-0 shadow-lg border border-dark-lighten flex flex-col items-stretch bg-dark w-max rounded-md overflow-hidden py-1 transition-all duration-200 origin-top-right ${isDropdownOpened
